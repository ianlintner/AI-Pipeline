...
def run_linting():
    ...
    # MyPy type checking
    success &= run_command("mypy . --ignore-missing-imports --no-strict-optional", "MyPy type checking")
...
def main():
    ...
    parser.add_argument("--full", action="store_true", help="Run full CI pipeline locally")
