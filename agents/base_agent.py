...
class BaseAgent(ABC):
    ...
    def send_status_update(self, request_id: str, status: str, message: str, metadata: Optional[Dict[str, Any]] = None):
    ...
    def handle_error(self, request_id: str, error_message: str, exception: Exception = None):
        """Handle errors and update state"""
        logger.error(f"Error in {self.agent_name} for request {request_id}: {error_message}")
