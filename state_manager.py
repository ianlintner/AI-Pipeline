...
class StateManager:
    ...
    def create_request_state(self, request_id: str, bug_report_id: str, initial_step: str) -> RequestState:
    ...
    def mark_completed(self, request_id: str, github_issue_number: int, github_issue_url: str) -> bool:
