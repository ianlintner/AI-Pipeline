...
class TestBugReportTriageService:
    ...
    def service(self, mock_agents):
        ...
        with patch('bug_report_service.TriageAgent') as mock_triage, \
    ...
    def test_get_request_status_success(self, service):
        ...
        service.coordinator.get_request_status.assert_called_once_with("test-request-id")
    ...
    def test_get_all_active_requests_exception(self, service):
        ...
        service.coordinator = Mock()
        service.coordinator.get_all_active_requests.side_effect = Exception("Requests error")
