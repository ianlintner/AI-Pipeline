...
class TestEndToEndIntegration:
    ...
    def service_with_mocks(self):
        ...
        with patch('kafka_utils.KafkaProducer') as mock_producer, \
    ...
    def test_bug_report_processing_workflow(self, service_with_mocks, sample_bug_report):
        """Test complete bug report processing workflow"""
        service = service_with_mocks
        
        # Mock successful processing at each stage
        with patch.object(service, 'initialize_agents') as mock_init_agents, \
...
class TestErrorRecovery:
    ...
    def test_redis_connection_failure_recovery(self, service_with_mocks):
        ...
        service.coordinator = Mock()
        service.coordinator.submit_bug_report.side_effect = Exception("Redis connection failed")
